...
class ToolTab(tk.Frame):
    def __init__(self, *args, **kwargs):
        ...
        def select_radiobutton(event):
            """
            This method will select the radiobutton that corresponds to a tool in the tool list.  This enables
            MouseWheel support for selecting tools
            :param event: MouseWheel scroll
            :return: None
            """
        ...
        def udpate_tool_event(event):
            ...
            tool_list[tool_id] = {'T': '', 'UPDATEBOOL': False,
                                  'DIA': '', 'LOC': '', 'FL': '', 'TYPE': '', 'OAL': '', 'OH': '', 'COMMENTS': ''}
